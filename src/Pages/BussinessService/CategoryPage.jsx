...
import FilterPanel from "../../components/BusinessService/CategoryPage/Filters";
...
import Pagination from "../../components/BusinessService/CategoryPage/Pagination";
...
const CategoryPage = () => {
  return (
    <div className="bg-[#faf9f9] py-8">
      <BreadCrumb />
      <div className="inline-flex items-center justify-between w-full lg:px-12 px-4">
        <FilterPanel />
        <p className="text-gray-500 text-xs">10,000+ Results</p>
      </div>

      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:px-10 px-4">
