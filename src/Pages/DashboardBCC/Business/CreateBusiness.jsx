						...
						<div className="mx-4  bg-white p-6 rounded-xl shadow-md">
							...
							<div className="flex flex-col lg:flex-row gap-8">
								...
								<div className="flex flex-col items-center w-full lg:w-1/4">
									...
									>
										{imagePreview || typeof inputs.businessAccount.logo === 'string' ? (
											<>
												<img
													src={typeof inputs.businessAccount.logo === 'string' ? inputs.businessAccount.logo : imagePreview}
													alt="Preview"
								...
								<div className="w-full">
									<div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:w-full">
										...
										<div>
											...
											<input
												type="text"
												value={inputs.businessAccount.website}
												onChange={e => handleInput('businessAccount.website', e.target.value)}
