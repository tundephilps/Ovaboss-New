...
export default function ShoppingCart() {
  ...
  const handleProceedTocheckout = () => {
    ...
    if (selectedKeys.length > 0) {
      const updatedItem = carts.filter((item) =>
        selectedKeys.includes(String(item.productId))
      );
              ...
              <div className="flex flex-col sm:flex-row lg:space-y-0 space-y-4">
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleRemoveCart(item.productId, item.variantDetails?.id)
                    }
                    disabled={isSaving}
                  >
              ...
              <button
                ...
                className={`${
                  getSelectedCount() > 0 || carts.length > 0
                    ? "bg-yellow-500"
                    : "bg-gray-300"
                } w-full text-black py-2 px-4 whitespace-nowrap rounded hover:bg-yellow-600 font-medium flex items-center justify-center`}
