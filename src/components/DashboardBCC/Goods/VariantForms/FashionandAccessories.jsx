  ...
  return (
    <div>
      <div className="mx-auto pb-4 grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div>
          <label className="block mb-1 font-semibold">Warranty Duration</label>
        ...
        <div>
          <label className="block mb-1 font-semibold">Skirts Type</label>
          <input type="text" className="w-full border rounded p-2" />
        </div>
        ...
        <div>
          <label className="block mb-1 font-semibold">Trouser Type</label>
          <input type="text" className="w-full border rounded p-2" />
        </div>
