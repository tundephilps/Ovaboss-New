...
const menuItems = [
  ...
  { icon: <FaUser className="text-xl" />, label: "Business", path: "/profile" },
  {
...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      } transition-all duration-300 h-full min-h-screen lg:block hidden bg-gradient-to-b from-[#000000] to-[#121212] text-white shadow-lg`}
    >
