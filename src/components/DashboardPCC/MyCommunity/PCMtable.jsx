...
export default function PCMtable() {
    ...
    <div className="p-4 bg-white rounded-md mt-6 mb-20">
      <div className="flex gap-4 items-center mb-4">
        ...
        <div className="relative">
          <button
            className="border px-4 py-2 rounded bg-[#faf9f9]  flex items-center text-[10px] gap-6"
      ...
      <div className="overflow-x-auto">
        <table className=" w-full border-separate border-spacing-y-2">
          <thead className=" bg-[#faf9f9] h-8 w-full">
            ...
            {data.map((person, index) => (
              ...
              >
                ...
                <td className="py-2  text-right">
                  <BsThreeDots className="text-gray-800 cursor-pointer" />
                </td>
              </tr>
            ))}
          </tbody>
