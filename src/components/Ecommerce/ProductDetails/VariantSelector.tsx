...
export default function VariantSelector({
  ...
  const [hoveredVariant, setHoveredVariant] =
    useState<ProductFullVariant | null>(null);
        ...
        return (
          ...
          >
            <button
              ...
              disabled={outOfStock}
              className={[
                "group relative w-full text-left rounded-xl border p-2 shadow-sm transition focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500",
                isSelected
